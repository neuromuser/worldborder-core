...
import com.neuromuser.worldbordercore.items.categories.PlanksItem;
...
public class RolledItemRegistry {
    ...
    public static void registerAll() {
        ...
        register(new PlanksItem(Items.OAK_PLANKS, Items.OAK_LOG, 0.5));
        register(new PlanksItem(Items.SPRUCE_PLANKS, Items.SPRUCE_LOG, 0.6));
        register(new PlanksItem(Items.BIRCH_PLANKS, Items.BIRCH_LOG, 0.5));
        register(new PlanksItem(Items.JUNGLE_PLANKS, Items.JUNGLE_LOG, 0.6));
        register(new PlanksItem(Items.ACACIA_PLANKS, Items.ACACIA_LOG, 0.8));
        register(new PlanksItem(Items.DARK_OAK_PLANKS, Items.DARK_OAK_LOG, 0.8));
        register(new PlanksItem(Items.MANGROVE_PLANKS, Items.MANGROVE_LOG, 0.9));
        register(new PlanksItem(Items.CHERRY_PLANKS, Items.CHERRY_LOG, 1.1));
        register(new PlanksItem(Items.CRIMSON_PLANKS, Items.CRIMSON_STEM, 1.5));
        register(new PlanksItem(Items.WARPED_PLANKS, Items.WARPED_STEM, 1.5));
